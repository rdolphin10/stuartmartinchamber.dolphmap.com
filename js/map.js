...
function initializeMap() {
    ...
    try {
        ...
        // Log all errors to console for debugging, but never show user-facing banners.
        // Mapbox fires error events for transient tile failures, network blips, and
        // WebGL context issues that are common on mobile — the map recovers on its own.
...
function showBrowserFallback() {
    ...
    // Get the current page URL for the copy button
    ...
    mapContainer.innerHTML = `
        ...
        ">
            ...
            <p style="margin: 0 0 24px; font-size: 15px; color: #555; max-width: 320px; line-height: 1.5;">
                This interactive map requires Safari or Chrome. Tap the button below to copy the link, then paste it in your browser.
            </p>
            <button onclick="
            ...
            <p style="margin: 16px 0 0; font-size: 13px; color: #888;">
                Or look for the ⋮ menu → "Open in Browser"
            </p>
        </div>
    `;
}
